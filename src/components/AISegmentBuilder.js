...
const AISegmentBuilder = ({ onBack, initialData, onNavigateToWebsiteSegments, onNavigateToSegmentReport }) => {
  ...
  const businessLinesMap = {
    'nike.com': ['Footwear', 'Men\'s Clothing', 'Women\'s Clothing', 'Children\'s Clothing', 'Bags & Packs'],
    'amazon.com': ['Computer Electronics', 'Home Appliances', 'Household Supplies', 'Toys & Games', 'Pet Food & Supplies'],
    'apple.com': ['Mobile Phones', 'Laptop Computers', 'Tablet PCs', 'Headphones', 'Watches & Watch Accessories'],
    'walmart.com': ['General Clothing', 'Food', 'Home Appliances', 'Toys & Games', 'Pet Food & Supplies'],
    'target.com': ['Home Furniture', 'Make-Up & Cosmetics', 'Baby Products', 'Household Supplies', 'Toys & Games'],
    'bestbuy.com': ['Televisions', 'Laptop Computers', 'Video Games, Consoles & Accessories', 'Headphones', 'Computer Electronics'],
    'homedepot.com': ['Hardware Tools & Accessories', 'Home Appliances', 'Lights & Lighting', 'Bathroom', 'Yard, Garden & Patio'],
    'lowes.com': ['Hardware Tools & Accessories', 'Home Appliances', 'Lights & Lighting', 'Bathroom', 'Yard, Garden & Patio'],
    'wayfair.com': ['Home Furniture', 'Home Decor & Interior Decorating', 'Bedding & Linens', 'Lights & Lighting'],
    'macys.com': ['Women\'s Clothing', 'Men\'s Clothing', 'Make-Up & Cosmetics', 'Perfumes & Fragrances', 'Jewelry'],
    'nordstrom.com': ['Women\'s Clothing', 'Men\'s Clothing', 'Footwear', 'Bags & Packs', 'Make-Up & Cosmetics'],
    'ulta.com': ['Make-Up & Cosmetics', 'Skin Care', 'Hair Care', 'Perfumes & Fragrances', 'Nail Care'],
    'sephora.com': ['Make-Up & Cosmetics', 'Skin Care', 'Hair Care', 'Perfumes & Fragrances'],
    'cvs.com': ['Drugs & Medications', 'Vitamins & Supplements', 'Oral Care', 'Personal care', 'Skin Care'],
    'walgreens.com': ['Drugs & Medications', 'Vitamins & Supplements', 'Oral Care', 'Personal care', 'Skin Care'],
    'petco.com': ['Pet Food & Supplies'],
    'petsmart.com': ['Pet Food & Supplies'],
    'rei.com': ['Camping & Outdoor Recreation', 'Footwear', 'Men\'s Clothing', 'Women\'s Clothing'],
    'gamestop.com': ['Video Games, Consoles & Accessories'],
    'staples.com': ['Office & School supplies', 'Computer Electronics', 'Laptop Computers']
  };
  ...
  const websiteSuggestions = [
    // Supported websites
    { url: 'nike.com', favicon: 'https://www.google.com/s2/favicons?domain=nike.com&sz=16' },
    { url: 'amazon.com', favicon: 'https://www.google.com/s2/favicons?domain=amazon.com&sz=16' },
    { url: 'apple.com', favicon: 'https://www.google.com/s2/favicons?domain=apple.com&sz=16' },
    { url: 'walmart.com', favicon: 'https://www.google.com/s2/favicons?domain=walmart.com&sz=16' },
    { url: 'target.com', favicon: 'https://www.google.com/s2/favicons?domain=target.com&sz=16' },
    { url: 'bestbuy.com', favicon: 'https://www.google.com/s2/favicons?domain=bestbuy.com&sz=16' },
    { url: 'homedepot.com', favicon: 'https://www.google.com/s2/favicons?domain=homedepot.com&sz=16' },
    { url: 'lowes.com', favicon: 'https://www.google.com/s2/favicons?domain=lowes.com&sz=16' },
    { url: 'wayfair.com', favicon: 'https://www.google.com/s2/favicons?domain=wayfair.com&sz=16' },
    { url: 'macys.com', favicon: 'https://www.google.com/s2/favicons?domain=macys.com&sz=16' },
    { url: 'nordstrom.com', favicon: 'https://www.google.com/s2/favicons?domain=nordstrom.com&sz=16' },
    { url: 'ulta.com', favicon: 'https://www.google.com/s2/favicons?domain=ulta.com&sz=16' },
    { url: 'sephora.com', favicon: 'https://www.google.com/s2/favicons?domain=sephora.com&sz=16' },
    { url: 'cvs.com', favicon: 'https://www.google.com/s2/favicons?domain=cvs.com&sz=16' },
    { url: 'walgreens.com', favicon: 'https://www.google.com/s2/favicons?domain=walgreens.com&sz=16' },
    { url: 'petco.com', favicon: 'https://www.google.com/s2/favicons?domain=petco.com&sz=16' },
    { url: 'petsmart.com', favicon: 'https://www.google.com/s2/favicons?domain=petsmart.com&sz=16' },
    { url: 'rei.com', favicon: 'https://www.google.com/s2/favicons?domain=rei.com&sz=16' },
    { url: 'gamestop.com', favicon: 'https://www.google.com/s2/favicons?domain=gamestop.com&sz=16' },
    { url: 'staples.com', favicon: 'https://www.google.com/s2/favicons?domain=staples.com&sz=16' },
    // Unsupported websites (for demonstration)
    { url: 'youtube.com', favicon: 'https://www.google.com/s2/favicons?domain=youtube.com&sz=16' },
    { url: 'facebook.com', favicon: 'https://www.google.com/s2/favicons?domain=facebook.com&sz=16' },
    { url: 'instagram.com', favicon: 'https://www.google.com/s2/favicons?domain=instagram.com&sz=16' },
    { url: 'netflix.com', favicon: 'https://www.google.com/s2/favicons?domain=netflix.com&sz=16' }
  ];
